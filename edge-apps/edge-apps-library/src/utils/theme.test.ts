...
describe('theme utilities', () => {
  ...
  describe('applyThemeColors', () => {
    test('should apply theme colors to CSS custom properties', () => {
      ...
      expect(document.documentElement.style.getPropertyValue('--theme-color-primary')).toBe(
        '#FF0000',
      )
      expect(document.documentElement.style.getPropertyValue('--theme-color-secondary')).toBe(
        '#00FF00',
      )
      expect(document.documentElement.style.getPropertyValue('--theme-color-tertiary')).toBe(
        '#0000FF',
      )
