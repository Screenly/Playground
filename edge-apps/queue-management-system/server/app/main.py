...
def get_display_status():
    ...
    return jsonify({"available_tills": available_tills, "busy_tills": busy_tills})
...
def set_till_busy(till_id):
    ...
    return jsonify({"till_id": till_id, "is_available": False, "status": "busy"})
...
def set_till_available(till_id):
    ...
    return jsonify({"till_id": till_id, "is_available": True, "status": "available"})
