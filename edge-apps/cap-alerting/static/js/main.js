(() => {
  ...
  // node_modules/.bun/heap@0.2.7/node_modules/heap/index.js
  ...
  // ../edge-apps-library/dist/utils/metadata.js
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/util.js
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/validator.js
  var defaultOptions = {
...
` || char === "\r";
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/xmlparser/OptionsBuilder.js
  var defaultOptions2 = {
    preserveOrder: false,
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/xmlparser/xmlNode.js
  var METADATA_SYMBOL;
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/xmlparser/DocTypeReader.js
  class DocTypeReader {
  ...
  // node_modules/.bun/strnum@2.1.1/node_modules/strnum/strnum.js
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/ignoreAttributes.js
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/xmlparser/OrderedObjParser.js
...
`);
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/xmlparser/node2json.js
  ...
  // node_modules/.bun/fast-xml-parser@5.3.2/node_modules/fast-xml-parser/src/xmlparser/XMLParser.js
  class XMLParser {
    constructor(options) {
  ...
  function parseCap(xml) {
    ...
    const alerts = [];
    alertsJson.forEach((a) => {
      const infosJson = a.info ? Array.isArray(a.info) ? a.info : [a.info] : [];
      const infos = infosJson.map((info) => {
        const resourcesJson = info.resource ? Array.isArray(info.resource) ? info.resource : [info.resource] : [];
        ...
        return {
          ...
          resources: resourcesJson.map((res) => {
            return {
  ...
  async function fetchCapData(feedUrl, offlineMode) {
    if (offlineMode) {
  ...
  function renderAlerts(alerts, nearestExit, lang, maxAlerts, playAudio) {
    ...
    slice.forEach((alert) => {
      ...
      if (alert.status) {
        ...
        let baseClasses = "w-full text-center font-black uppercase tracking-[0.15em] flex-shrink-0 status-stripe-pattern status-banner-text py-[2.5vh] px-[4vw] text-white ";
      ...
      meta.className = "severity-badge inline-block text-white rounded-xl font-black uppercase tracking-wider flex-shrink-0 severity-badge-text px-[4vw] py-[2vh]";
...
Nearest exit: ${nearestExit}`;
        ...
        instructionBox.className = "instruction-box rounded-xl flex-shrink-0 px-[4vw] py-[2.5vh] mx-[5vw] mb-[2vh]";
  ...
  async function startApp() {
    ...
    try {
      ...
      localStorage.setItem("screenly_settings", JSON.stringify(settings2));
    } catch (_) {
      const cached = localStorage.getItem("screenly_settings");
      settings2 = cached ? JSON.parse(cached) : {};
    }
    try {
      metadata2 = getMetadata();
      localStorage.setItem("screenly_metadata", JSON.stringify(metadata2));
    } catch (_) {
      const cachedMeta = localStorage.getItem("screenly_metadata");
      metadata2 = cachedMeta ? JSON.parse(cachedMeta) : {};
    }
    const feedUrl = settings2.cap_feed_url || "";
    const interval = parseInt(settings2.refresh_interval || "5", 10);
    const lang = settings2.language || "en";
    const maxAlerts = parseInt(settings2.max_alerts || "3", 10);
    const playAudio = (settings2.audio_alert || "false") === "true";
    const offlineMode = (settings2.offline_mode || "false") === "true";
    const testMode = (settings2.test_mode || "false") === "true";
    const demoMode = (settings2.demo_mode || "false") === "true";
    console.log("CAP Settings:", {
      playAudio,
      audio_alert: settings2.audio_alert,
      demoMode,
      testMode,
      maxAlerts
    });
    const tags = metadata2.tags || [];
