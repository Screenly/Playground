...
// e1ca647d-e11c-4043-bbed-eb1b3d176e7d
...
// const apiKey = 'e1ca647d-e11c-4043-bbed-eb1b3d176e7d'
console.log("cors", screenly.cors_proxy_url);
// res.setHeader("Access-Control-Allow-Origin", "*");

http://api.511.org/transit/stops?api_key=[your_key]&operator_id=[operatorID]

fetch(`${proxyUrl}/${apiUrl}/StopMonitoring?${apiKey}&agency=AC&stop_id=stopId`, {
  method: 'GET',
  ...
  .then( transitData => {
    console.log("Success:", transitData)
  })
  .catch(err => {
...
//   }
// }
// // http://api.511.org/transit/StopMonitoring?api_key=[your_key]&agency=AC
// async function fetchBusData () {
//   try {
//     // Bus Route Detail API Request
//     // https://api.511.org/transit/stopPlaces?api_key={your-key}&operator_id=AC&stop_id=58538
//     const stopData = await getCachedData(`${apiUrl}/stopPlaces?api_key=${apiKey}&operator_id=AC&stop_id=${stopId}`, 'stopData')
//     // Bus Line Status API Request
//     // http://api.511.org/transit/lines?api_key={your-key}&operator_id=AC
//     const lineData = await getCachedData(`${apiUrl}//lines?api_key=${apiKey}&operator_id=AC`, 'lineData')
